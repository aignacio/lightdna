...
// eg: `data-parsley-stop-on-first-failing-constraint="false"`
  ...
  var ParsleyDefaults = {
    ...
    errorsWrapper: '<ul class="parsley-errors-list error-parsley"></ul>',
...
window.ParsleyConfig.i18n.en = jQuery.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    ...
    number:       "Este deve ser um valor válido de número.",
    integer:      "Este deve ser um valor válido de inteiro.",
    digits:       "Devem ser dígitos.",
    alphanum:     "Este valor deve ser alfa numérico"
  },
  ...
  minlength:      "Valor informado muito curto, deve possuir %s ou mais caracteres.",
  maxlength:      "Valor informado muito longo, deve possuir %s ou menos caracteres.",
  length:         "Este comprimento é inválido. Deve possuir entre %s e %s caracteres.",
  mincheck:       "You must select at least %s choices.",
  maxcheck:       "You must select %s choices or fewer.",
  check:          "You must select between %s and %s choices.",
  equalto:        "Este valor deve ser igual a %s."
});
